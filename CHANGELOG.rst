...
- MWs can now be created without an ``end``, meaning they will have no end time. If such MW starts running, it can only be stopped by request and not by updating the MW.
